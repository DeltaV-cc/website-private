        ...
        <div className="grid md:grid-cols-12 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2.5">
              ...
              <a href="https://github.com/DeltaV-cc/website-private" target="_blank" rel="noopener noreferrer" aria-label="Delta V on GitHub" className="inline-flex items-center gap-1.5 text-[var(--text-tertiary)] hover:text-[var(--accent-primary)] transition-colors duration-150 text-sm">
