      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-8 pt-16 pb-24">
        ...
        <section className="relative mb-16 rounded-3xl border border-[var(--border-default)] bg-gradient-to-br from-[var(--bg-surface)] via-[var(--bg-surface)] to-[var(--accent-cyan)]/[0.03] overflow-hidden">
          ...
          <div className="relative grid lg:grid-cols-[1fr_420px] gap-0">
            <div className="flex flex-col justify-center px-6 md:px-12 py-12 md:py-16">
              ...
              <h2 className="text-3xl md:text-4xl font-semibold tracking-[-1.5px] mb-4">Book a 30‑minute call</h2>
              ...
              <div className="flex flex-wrap gap-3 text-sm text-[var(--text-tertiary)]">
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--bg-deep)] border border-[var(--border-default)]">
                  <span className="w-2 h-2 rounded-full bg-[var(--accent-green)]" /> 30 min
                </span>
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--bg-deep)] border border-[var(--border-default)]">
        ...
        <section className="max-w-4xl rounded-2xl border border-[var(--border-default)] bg-[var(--bg-surface)] p-6 md:p-8 relative overflow-hidden mb-16" aria-labelledby="why-us-heading">
          ...
          <div className="mt-8 grid gap-px overflow-hidden rounded-xl border border-[var(--border-default)] bg-[var(--border-default)] md:grid-cols-2">
            {[
              { number: '01', title: 'Tech natives', body: 'Passionate professionals at the forefront of decentralization and digital upskilling. We do not just consult — we build, operate, and live the stack.', accent: 'var(--accent-cyan)' },
              { number: '02', title: 'Self-ownership focused', body: 'Every solution prioritizes user control. Data, keys, and decisions stay where they belong: with you.', accent: 'var(--accent-purple)' },
            ].map((item) => (
