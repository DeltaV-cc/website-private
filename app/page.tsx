...
const capabilities = [
  { href: '/ai/', index: '01', title: 'AI Engineering', bullets: [{ label: 'Tailored multi-agent systems', href: '/ai/#agents' }, { label: 'Inference and model engineering', href: '/ai/#inference' }, { label: 'Ongoing AI engineer support', href: '/ai/#retainer' }], accent: 'text-[var(--accent-cyan)]', titleTint: 'text-[var(--accent-cyan)]/90', line: 'border-[var(--accent-cyan)]/30' },
  { href: '/web3/', index: '02', title: 'Web3', bullets: [{ label: 'SOTA setup and architecture', href: '/web3/#architecture' }, { label: 'Web3 intelligence and OSINT', href: '/web3/#intelligence' }, { label: 'Growth, public goods, and community building', href: '/web3/#growth' }], accent: 'text-[var(--accent-orange)]', titleTint: 'text-[var(--accent-orange)]/90', line: 'border-[var(--accent-orange)]/30' },
  { href: '/forge/', index: '03', title: 'Skill Forge', bullets: [{ label: 'Personal AI Mastery', href: '/forge/course/#ai-mastery' }, { label: 'AI Engineering Bootcamp', href: '/forge/course/#ai-engineering' }, { label: 'OpSec training and auditing', href: '/web3/#opsec' }], accent: 'text-[var(--accent-purple)]', titleTint: 'text-[var(--accent-purple)]/90', line: 'border-[var(--accent-purple)]/30' },
];
...
export default function DeltaVSite() {
  return <main className="relative isolate">
    ...
    <section className="page-container pb-24" aria-labelledby="cta-heading"><div className="relative overflow-hidden border border-[var(--border-default)] bg-[var(--bg-surface)] p-8 md:p-14"><div className="relative z-10"><div className="grid md:grid-cols-[.7fr_1.3fr] gap-10 mb-8"><div><div className="eyebrow">Curated Intel</div><h2 className="section-title">Curated Intel</h2></div><div className="max-w-md self-end"><p className="leading-relaxed text-[var(--text-secondary)]">Curated intel from research labs, key industry leaders, emerging talents, and engineering communities.</p></div></div><CuratedIntel /><div className="mt-6 flex justify-center"><Link href="/intelhub/" className="button-secondary">Explore IntelHub <Arrow /></Link></div></div><div className="relative mt-10 border-t border-[var(--border-default)] pt-8"><div className="eyebrow text-[var(--accent-orange)] mb-3">Stay in the Loop</div><div className="relative overflow-hidden border border-[var(--border-default)] bg-[var(--bg-deep)]"><InkGarden compact /><div className="absolute inset-0 bg-gradient-to-r from-[var(--bg-deep)] via-[var(--bg-deep)]/85 to-transparent" /><div className="relative max-w-xl p-8 md:p-10"><h2 id="cta-heading" className="section-title">High-signal updates only.</h2><p className="mt-4 text-[var(--text-secondary)]">Curated intelligence, technical breakdowns, and new tutorials delivered directly.</p></div></div><div className="mt-6 flex flex-wrap items-center justify-center gap-3"><Link href="/intelhub/" className="button-primary">Browse IntelHub <Arrow /></Link><Link href="/tutorials/" className="button-secondary">Tutorials <Arrow /></Link><Link href="/blog/" className="button-secondary">Blog <Arrow /></Link><Link href="/contact/" className="button-secondary md:ml-6">Get in touch <Arrow /></Link></div></div></div></section>
    </div>
  </main>;
}
