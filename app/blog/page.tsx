  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed] font-sans">
      ...
      <div className="max-w-5xl mx-auto px-8 py-16">
        ...
        <p className="text-[#aaa] text-lg mb-12">High-signal writing from the Content Forge — deep dives, casual thoughts, and tutorials on sovereign AI, Web3 OpSec, and self-sovereign systems.</p>
