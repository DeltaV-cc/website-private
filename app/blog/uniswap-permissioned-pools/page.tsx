...
export default function UniswapPermissionedPoolsPost() {
  return (
    ...
    >
      <p>
        On July 24, 2026, Uniswap Labs announced <strong className="text-[var(--text-primary)]">Permissioned Pools on Uniswap v4</strong> — a hook
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 my-8">
        {[
          { value: '$11T', label: 'Tokenized Assets by 2030', color: 'from-[var(--accent-gold)] to-[var(--accent-gold)]/50' },
          { value: '3', label: 'Launch Partners', color: 'from-[var(--accent-purple)] to-[var(--accent-purple)]/50' },
          { value: 'v4 Hooks', label: 'Compliance Engine', color: 'from-[var(--accent-cyan)] to-[var(--accent-cyan)]/50' },
          { value: '24/7', label: 'Institutional Trading', color: 'from-[var(--accent-green)] to-[var(--accent-green)]/50' },
        ].map((stat) => (
          <div key={stat.label} className="bg-[var(--bg-elevated)] border border-[var(--border-default)] rounded-2xl p-5 text-center">
            <div className={`text-2xl md:text-3xl font-bold bg-gradient-to-br ${stat.color} bg-clip-text text-transparent`}>
              {stat.value}
            </div>
            <div className="text-[11px] text-[var(--text-muted)] mt-1 uppercase tracking-[1px]">{stat.label}</div>
          </div>
        ))}
      </div>

      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-12 mb-4">The Announcement</h2>

      <p>
        Uniswap v4's hook architecture was always designed to be extensible. But what Uniswap Labs shipped today
        is a <strong className="text-[var(--text-primary)]">generalized, open-source, institutional-grade standard</strong> for
      ...
      <p>
        The key insight: <strong className="text-[var(--text-primary)]">compliance lives onchain.</strong> Every swap checks the
      ...
      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-12 mb-4">The Partners</h2>
      ...
      <div className="space-y-5 my-6">
        ...
        <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)]">Superstate</h3>
          </div>
        ...
        <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)]">Securitize (DS Protocol)</h3>
          </div>
          <p className="text-sm text-[var(--text-tertiary)]">
        ...
        <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)]">Dowgo (ERC-3643 + EU DLT Pilot Regime)</h3>
          </div>
          <p className="text-sm text-[var(--text-tertiary)]">
      ...
      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-12 mb-4">How It Works: Protocol-Level Compliance</h2>

      <p>
        The architecture is elegant and deeply pragmatic. Here's what happens under the hood:
      </p>

      <div className="bg-[var(--bg-card)] border border-[var(--border-default)] rounded-2xl p-6 my-6">
        <ol className="space-y-4 text-sm text-[var(--text-secondary)] list-decimal list-inside">
          <li>
            <strong className="text-[var(--text-primary)]">Hook checks on every swap.</strong> Before any trade executes,
          ...
          <li>
            <strong className="text-[var(--text-primary)]">Allowlist verification for LPs.</strong> Before an LP position
          ...
          <li>
            <strong className="text-[var(--text-primary)]">Virtual accounting for custody.</strong> Permissioned assets
          ...
          <li>
            <strong className="text-[var(--text-primary)]">Administration controls.</strong> Issuers retain the ability
          ...
          <li>
            <strong className="text-[var(--text-primary)]">Compliance at the protocol level.</strong> None of this is
      ...
      <div className="bg-[var(--bg-card)] border-l-2 border-[var(--accent-gold)] rounded-r-xl p-5 my-8">
        <p className="text-sm text-[var(--text-tertiary)]">
          <strong className="text-[var(--accent-gold)]">The architecture is the message:</strong> Institutions get to
      ...
      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-12 mb-4">
        Why This Matters for TradFi
      </h2>

      <p>
        The tokenized asset market is projected to reach <strong className="text-[var(--text-primary)]">$11 trillion by 2030</strong>.
      ...
      <ol className="space-y-4 my-6 text-[var(--text-secondary)] list-decimal list-inside">
        <li>
          <strong className="text-[var(--text-primary)]">First generalized, open-source institutional AMM standard.</strong>
        ...
        <li>
          <strong className="text-[var(--text-primary)]">Issuers get AMM liquidity + DeFi composability without giving up control.</strong>
        ...
        <li>
          <strong className="text-[var(--text-primary)]">Investors get direct onchain trading for assets that couldn't trade on DEXs before.</strong>
        ...
        <li>
          <strong className="text-[var(--text-primary)]">Institutions get the full package.</strong> Deep liquidity. 24/7 trading.
        ...
        <li>
          <strong className="text-[var(--text-primary)]">The architecture respects institutional choice.</strong>
      ...
      <div className="bg-[var(--bg-elevated)] border border-[var(--accent-gold)]/20 rounded-2xl p-6 my-8">
        <h3 className="text-lg font-semibold text-[var(--accent-gold)] mb-3">
      ...
      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-12 mb-4">The Larger Context</h2>
      ...
      <ul className="space-y-3 my-6 text-sm text-[var(--text-secondary)]">
        <li>
          <strong className="text-[var(--text-primary)]">Spark migrated $150M to v4 (DualPool).</strong> One of DeFi's
        ...
        <li>
          <strong className="text-[var(--text-primary)]">Uniswap is live on Robinhood Chain.</strong> The retail-to-DeFi
          pipeline is now connected directly to the protocol that the permissioned standard runs on.
        </li>
        <li>
          <strong className="text-[var(--text-primary)]">BlackRock and Securitize are already building.</strong>
        ...
        <li>
          <strong className="text-[var(--text-primary)]">EU DLT Pilot Regime provides regulatory cover.</strong>
      ...
      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-12 mb-4">The TradFi Relevance Section</h2>

      <p className="text-[var(--accent-gold)] text-sm font-semibold uppercase tracking-[2px] mb-4">
      ...
      <ol className="space-y-2 my-4 text-sm text-[var(--text-secondary)] list-decimal list-inside">
        <li><strong className="text-[var(--text-primary)]">No standard for compliance-at-the-protocol-level.</strong> Solved: v4 hooks.</li>
        <li><strong className="text-[var(--text-primary)]">No deep liquidity venue that works with regulated assets.</strong> Solved: Uniswap is the deepest DEX by volume and TVL.</li>
        <li><strong className="text-[var(--text-primary)]">No regulatory clarity on how tokenized securities trade on DLT.</strong> Solved (in progress): EU DLT Pilot, US crypto legislation, and major asset managers building on these rails.</li>
      </ol>
      <p>
      ...
      <div className="bg-[var(--bg-card)] border-l-2 border-[var(--accent-green)] rounded-r-xl p-5 my-8">
        <p className="text-sm text-[var(--text-tertiary)]">
          <strong className="text-[var(--accent-green)]">The bottom line:</strong> Permissioned Pools on Uniswap v4 are
