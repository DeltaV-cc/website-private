  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-8">
        {[
          { value: '14.6M', label: 'Parameters', color: 'text-[var(--accent-cyan)]' },
          { value: '10×+', label: 'Faster than original', color: 'text-[var(--accent-purple)]' },
          { value: 'Zero-shot', label: 'No fine-tuning', color: 'text-[var(--accent-gold)]' },
          { value: 'Edge', label: 'Jetson / GPU deployable', color: 'text-[var(--accent-orange)]' },
        ].map((stat) => (
          <div key={stat.label} className="bg-[var(--bg-elevated)] border border-[var(--border-default)] rounded-2xl p-4 text-center">
      ...
      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-10 mb-4">What It Does</h2>

      <p>
        <strong className="text-[var(--text-primary)]">Fast FoundationStereo</strong> is NVIDIA's 
      ...
      <p>
        The architecture is a <strong className="text-[var(--text-primary)]">transformer-CNN hybrid</strong> — 
        ...
        <strong className="text-[var(--text-primary)]"> pruning, knowledge distillation, and neural architecture search</strong>. 
      ...
      <div className="bg-[var(--bg-card)] border-l-2 border-[var(--accent-cyan)] rounded-r-xl p-5 my-6 text-sm">
        <p className="text-[var(--text-tertiary)]">
          <strong className="text-[var(--accent-cyan)]">Why zero-shot matters:</strong> Previous stereo depth models 
      ...
      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-10 mb-4">The Bigger Pattern — Every Frontier Model Compresses</h2>

      <p>
        This isn't just about stereo vision. NVIDIA just illustrated the 
        <strong className="text-[var(--text-primary)]">compression-to-deployment pipeline</strong> that is becoming the 
        ...
        <table className="w-full text-sm text-left border-collapse">
          <thead>
            <tr className="border-b border-[var(--border-default)]">
              <th className="py-3 px-4 text-[var(--text-muted)] font-medium uppercase tracking-[1px] text-xs">Domain</th>
              <th className="py-3 px-4 text-[var(--text-muted)] font-medium uppercase tracking-[1px] text-xs">Frontier Model</th>
              <th className="py-3 px-4 text-[var(--text-muted)] font-medium uppercase tracking-[1px] text-xs">Compressed → Edge</th>
              <th className="py-3 px-4 text-[var(--text-muted)] font-medium uppercase tracking-[1px] text-xs">Platform</th>
            </tr>
          </thead>
          <tbody className="text-[var(--text-tertiary)]">
            <tr className="border-b border-[var(--border-default)]">
              <td className="py-3 px-4 text-[var(--text-primary)] font-medium">Vision</td>
              <td className="py-3 px-4">FoundationStereo</td>
              <td className="py-3 px-4 text-[var(--accent-cyan)]">Fast FoundationStereo</td>
              <td className="py-3 px-4">Jetson / GPU</td>
            </tr>
            <tr className="border-b border-[var(--border-default)]">
              <td className="py-3 px-4 text-[var(--text-primary)] font-medium">Language</td>
              <td className="py-3 px-4">GPT-4 / Claude</td>
              <td className="py-3 px-4 text-[var(--accent-cyan)]">llama.cpp 4-bit quants</td>
              <td className="py-3 px-4">Laptop / Phone</td>
            </tr>
            <tr className="border-b border-[var(--border-default)]">
              <td className="py-3 px-4 text-[var(--text-primary)] font-medium">Speech</td>
              <td className="py-3 px-4">Whisper Large</td>
              <td className="py-3 px-4 text-[var(--accent-cyan)]">Whisper tiny / distilled</td>
              <td className="py-3 px-4">Raspberry Pi</td>
            </tr>
            <tr>
              <td className="py-3 px-4 text-[var(--text-primary)] font-medium">Image Gen</td>
              <td className="py-3 px-4">Stable Diffusion XL</td>
              <td className="py-3 px-4 text-[var(--accent-cyan)]">SD Turbo / LCM-LoRA</td>
      ...
      <p>
        The pattern is identical across domains: <strong className="text-[var(--text-primary)]">train frontier at massive scale → 
        distill/prune/quantize → deploy on edge hardware</strong>. This is how AI escapes 
        the data center and becomes infrastructure.
      </p>

      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-10 mb-4">Industry Implications</h2>

      <p>
        <strong className="text-[var(--text-primary)]">Robotics.</strong> Humanoid and mobile robots need real-time spatial 
      ...
      <p>
        <strong className="text-[var(--text-primary)]">Manufacturing.</strong> Visual inspection, pick-and-place, and 
      ...
      <p>
        <strong className="text-[var(--text-primary)]">Autonomous Vehicles.</strong> Stereo cameras cost roughly 1/50th 
      ...
      <p>
        <strong className="text-[var(--text-primary)]">Defense & Security.</strong> Drone navigation, surveillance, and 
      ...
      <p>
        <strong className="text-[var(--text-primary)]">Healthcare.</strong> Surgical robotics, endoscopic navigation, and 
      ...
      <div className="bg-[var(--bg-card)] border-l-2 border-[var(--accent-purple)] rounded-r-xl p-5 my-6 text-sm">
        <p className="text-[var(--text-tertiary)] mb-2">
          <strong className="text-[var(--accent-purple)]">The opsec angle:</strong>
        </p>
        <p className="text-[var(--text-tertiary)]">
      ...
      <h2 className="text-2xl font-semibold text-[var(--text-primary)] mt-10 mb-4">The Takeaway</h2>

      <p>
        Fast FoundationStereo is a great model. But the bigger story is the 
        <strong className="text-[var(--text-primary)]">compression pipeline as a product strategy</strong>. NVIDIA is 
