    ...
    >
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#aaa] leading-relaxed">HOOD dropped 5% after the raise. Repeat of the 2024 zero-coupon convertible strategy. Crypto division Q1 2026 volume up 187% YoY. Institutional buyers get a short-vol position on Robinhood equity.</p>
            </div>
          </div>
          <div className="flex gap-3">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#aaa] leading-relaxed">USX at 525+ hours, 5,783 bps below peg — now joined by pmUSD, apxUSD, and USDA at critical severity. PSI at 93.4 (BEDROCK for 20th day). Stablecoin market bifurcating: institutional assets structurally sound, small-cap algorithmic pegs entering systemic failure.</p>
            </div>
          </div>
          <div className="flex gap-3">
            <span className="w-2 h-2 rounded-full bg-[#ef4444] mt-1.5 flex-shrink-0" />
            <div>
              ...
              <p className="text-xs text-[#aaa] leading-relaxed">The largest hack of the summer. $4.4M to buy 1% of BONK, proposal with no timelock, 2.9% turnout on Solana's Realms. Every DAO with low participation is exposed.</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#111] border border-[#222] rounded-2xl p-5 my-4">
        <div className="border-l-2 border-[#ef4444] pl-4">
          ...
          <p className="text-xs text-[#888]">$4.4M to buy 1% of BONK supply. Buried a treasury transfer inside an innocuous proposal. Passed with 2.9% turnout on Solana's Realms. No timelock. No smart contract exploit — pure governance failure.{' '}
        ...
        <div className="mt-4 p-3 rounded-xl bg-[#1a1a1a] border border-[#222]">
          <p className="text-xs text-[#aaa]">
            <strong className="text-[#ededed]">Takeaway:</strong> governance attacks are the dominant exploit vector this cycle. DAOs need quorum minimums and mandatory timelocks.
          </p>
        </div>
      ...
      <div className="bg-[#111] border border-[#222] rounded-2xl p-5 my-4">
        ...
        <p className="text-sm text-[#aaa] leading-relaxed">
          Pharos digest #139 (July 13): USX at 525 hours, 5,783 bps below peg — joined by <strong className="text-[#ef4444]">pmUSD, apxUSD, and USDA at critical severity</strong>. Unprecedented breadth in algorithmic/undercollateralized pegs.
        </p>
        ...
        <p className="text-sm text-[#aaa] leading-relaxed mt-3">
          PSI at 93.4 despite four depegs — stressed assets are small-cap (&lt;$50M combined). USDT burns: $1.15B. BUIDL supply growing. DAI bands stable.{' '}
      ...
      <div className="bg-[#111] border border-[#222] rounded-2xl p-5 my-4">
        ...
        <p className="text-xs text-[#444] mt-3 pt-3 border-t border-[#1a1a1a]">
          Total unlocks: <strong className="text-[#ededed]">~$37.2M</strong>. Connex leads at $21M.{' '}
