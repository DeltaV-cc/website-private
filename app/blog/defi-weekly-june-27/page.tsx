    ...
    >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div>
            ...
            <div className="text-sm font-semibold text-[var(--text-primary)]">
              <span className="text-[var(--accent-red)]">$59,300</span>
              <span className="text-[var(--text-muted)] mx-1">–</span>
              <span className="text-[var(--accent-green)]">$65,200</span>
            </div>
            <div className="text-[10px] text-[var(--text-muted)] mt-0.5">Low · High · +6.5%</div>
          </div>
          <div>
            <div className="text-[10px] text-[var(--text-muted)] uppercase tracking-[1px] mb-1">ETH Range</div>
            <div className="text-sm font-semibold text-[var(--text-primary)]">
              <span className="text-[var(--accent-red)]">$1,530</span>
              <span className="text-[var(--text-muted)] mx-1">–</span>
              <span className="text-[var(--accent-green)]">$2,240</span>
            </div>
            <div className="text-[10px] text-[var(--text-muted)] mt-0.5">Low · High · +11.8%</div>
          </div>
          <div>
            <div className="text-[10px] text-[var(--text-muted)] uppercase tracking-[1px] mb-1">Dow / Nasdaq</div>
            <div className="text-sm font-semibold text-[var(--text-primary)]">
              <span className="text-[var(--accent-green)]">53,086</span>
              <span className="text-[var(--text-muted)] mx-1">/</span>
              <span className="text-[var(--accent-red)]">−0.2%</span>
            </div>
            <div className="text-[10px] text-[var(--text-muted)] mt-0.5">Dow record · Nasdaq-100 flat</div>
          </div>
          <div>
            <div className="text-[10px] text-[var(--text-muted)] uppercase tracking-[1px] mb-1">AI Capex Heat</div>
            <div className="text-sm font-semibold text-[var(--accent-red)]">Rotation</div>
            <div className="flex items-center gap-1 mt-1">
              <div className="flex-1 h-1 bg-[var(--bg-elevated)] rounded-full overflow-hidden">
                <div className="h-full bg-[var(--accent-red)] rounded-full" style={{ width: '35%' }} />
              </div>
              <span className="text-[10px] text-[var(--text-muted)]">Corning −23.8%</span>
            </div>
            <div className="text-[10px] text-[var(--text-muted)] mt-0.5">$600B+ capex · 46% faster than revs</div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="border-l-2 border-[var(--accent-red)] pl-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-semibold text-[var(--text-primary)]">BonkDAO — $19.3M</span>
              <span className="text-[10px] px-2 py-0.5 rounded bg-[var(--accent-red)]/15 text-[var(--accent-red)]">Governance Attack</span>
              <span className="text-[10px] text-[var(--text-muted)]">July 6</span>
            </div>
            <p className="text-xs text-[var(--text-muted)]">$4.4M to buy 1% of BONK supply. No-exploit treasury drain via governance on Solana Realms. 2.9% turnout, zero timelock. Every DAO exposed.{' '}
          ...
          <div className="border-l-2 border-[var(--accent-red)] pl-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-semibold text-[var(--text-primary)]">Summer Finance — $6.04M</span>
              <span className="text-[10px] px-2 py-0.5 rounded bg-[var(--accent-red)]/15 text-[var(--accent-red)]">NAV Manipulation</span>
              <span className="text-[10px] text-[var(--text-muted)]">July 6</span>
            </div>
            <p className="text-xs text-[var(--text-muted)]">A capped-for-removal stale Ark asset still counted in vault NAV — attacker donated it back to inflate share price, then drained real liquidity in one atomic transaction. Protocol paused vaults after detection.{' '}
          ...
          <div className="border-l-2 border-[var(--accent-orange)] pl-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-semibold text-[var(--text-primary)]">Altura — $39M Raised, Vault Closed</span>
              <span className="text-[10px] px-2 py-0.5 rounded bg-[var(--accent-orange)]/15 text-[var(--accent-orange)]">Investigation</span>
              <span className="text-[10px] text-[var(--text-muted)]">Early July</span>
            </div>
            <p className="text-xs text-[var(--text-muted)]">Gold-backed RWA yield protocol. $39M raised. Funds traced through Tron wallets tied to Kraken. Verifier controlled by COO's own project. Dashboard admitted it verified nothing. Depositors waiting.{' '}
          ...
          <div className="border-l-2 border-[var(--accent-red)] pl-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-semibold text-[var(--text-primary)]">SecondFi — $2.4M</span>
              <span className="text-[10px] px-2 py-0.5 rounded bg-[var(--accent-red)]/15 text-[var(--accent-red)]">Key Disclosure</span>
              <span className="text-[10px] text-[var(--text-muted)]">Recent</span>
            </div>
            <p className="text-xs text-[var(--text-muted)]">A single missing secret in the signing code made every on-chain transaction a private key disclosure. 374 wallets drained on Cardano. One line of missing code.{' '}
          ...
          <div className="border-l-2 border-[var(--accent-red)] pl-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-semibold text-[var(--text-primary)]">Secret Network Bridge — $4.67M</span>
              <span className="text-[10px] px-2 py-0.5 rounded bg-[var(--accent-red)]/15 text-[var(--accent-red)]">Bridge</span>
              <span className="text-[10px] text-[var(--text-muted)]">Recent</span>
            </div>
            <p className="text-xs text-[var(--text-muted)]">Two missing validation checks in a forked IBC contract let attacker forge deposits with a fake Cosmos chain. Drain went undetected for 7 days.{' '}
          ...
          <div className="border-l-2 border-[var(--accent-red)] pl-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-semibold text-[var(--text-primary)]">Aztec Bridge — $2.20M</span>
              <span className="text-[10px] px-2 py-0.5 rounded bg-[var(--accent-red)]/15 text-[var(--accent-red)]">ZK Verification</span>
              <span className="text-[10px] text-[var(--text-muted)]">Recent</span>
            </div>
            <p className="text-xs text-[var(--text-muted)]">Legacy rollup contract lost funds after a ZK proof passed a broken root-binding check. One deprecated contract, one flawed escape hatch.{' '}
          ...
          <div className="border-l-2 border-[var(--accent-red)] pl-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-semibold text-[var(--text-primary)]">TesseraDAO — Admin Privilege Abuse</span>
              <span className="text-[10px] px-2 py-0.5 rounded bg-[var(--accent-red)]/15 text-[var(--accent-red)]">Admin Keys</span>
              <span className="text-[10px] text-[var(--text-muted)]">Recent</span>
            </div>
            <p className="text-xs text-[var(--text-muted)]">Admin privilege exploit — classic centralized control failure.{' '}
      ...
      <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] rounded-2xl p-5 my-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-base font-semibold text-[var(--text-primary)]">13 Active Depegs — Four at Critical Severity</h3>
        </div>
        <p className="text-sm text-[var(--text-tertiary)] leading-relaxed">
          Pharos digest #136 (July 10): USX at 453+ hours, 5,783 bps below peg. Now joined by pmUSD, apxUSD, and USDA at critical severity — <strong className="text-[var(--accent-red)]">13 active depegs</strong> across the long-tail market. This breadth is unprecedented. The week's Open USD announcement and Robinhood Chain's USDG launch are launching into a stablecoin market that is simultaneously consolidating at the top and fracturing at the bottom.
        </p>
        <div className="grid md:grid-cols-3 gap-3 my-4">
          <div className="bg-[var(--bg-card)] rounded-xl p-3 border border-[var(--border-default)]">
            ...
            <div className="text-lg font-mono text-[var(--accent-red)]">13</div>
            <div className="text-[10px] text-[var(--text-muted)]">4 critical · 9 monitored</div>
          </div>
          <div className="bg-[var(--bg-card)] rounded-xl p-3 border border-[var(--border-default)]">
            ...
            <div className="text-[10px] text-[var(--text-muted)]">BEDROCK · 17th consecutive day</div>
          </div>
          <div className="bg-[var(--bg-card)] rounded-xl p-3 border border-[var(--border-default)]">
            ...
            <div className="text-[10px] text-[var(--text-muted)]">USDT $185B · USDC $76B</div>
          </div>
        </div>
        ...
        <p className="text-xs text-[var(--text-muted)] mt-3">Sources: Pharos Watch, DeFi Llama</p>
      </div>
      ...
      <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] rounded-2xl p-5 my-4">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-[var(--text-primary)] font-semibold">Connex — $21.04M Unlock</p>
              <p className="text-xs text-[var(--text-muted)]">July 15 · Ecosystem ($13.1M) + Treasury ($7.95M)</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-2 h-2 rounded-full bg-[var(--accent-orange)] flex-shrink-0" />
            <div>
              <p className="text-sm text-[var(--text-primary)] font-semibold">Arbitrum (ARB) — $8.69M Unlock</p>
              <p className="text-xs text-[var(--text-muted)]">July 16 · Team ($5.27M) + Investors ($3.43M) · 0.93% supply</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-2 h-2 rounded-full bg-[var(--accent-orange)] flex-shrink-0" />
            <div>
              <p className="text-sm text-[var(--text-primary)] font-semibold">Sei — $5.95M Unlock</p>
              <p className="text-xs text-[var(--text-muted)]">July 14 · Private sale + Team + Staking rewards</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-2 h-2 rounded-full bg-[var(--accent-cyan)] flex-shrink-0" />
            <div>
              <p className="text-sm text-[var(--text-primary)] font-semibold">Robinhood Chain · Institutional Onboarding Begins</p>
              <p className="text-xs text-[var(--text-muted)]">July 10+ · Stock tokens, Earn (~7% APY on USDG via Morpho), Uniswap AMM live</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-2 h-2 rounded-full bg-[var(--accent-cyan)] flex-shrink-0" />
            <div>
              <p className="text-sm text-[var(--text-primary)] font-semibold">SEC Crypto Rulemaking · Agenda Item</p>
              <p className="text-xs text-[var(--text-muted)]">July · Robinhood Chain compliance, stablecoin registration in scope</p>
            </div>
          </div>
        </div>
        <p className="text-xs text-[var(--text-muted)] mt-3 pt-3 border-t border-[var(--border-default)]">
          Total unlocks: <strong className="text-[var(--text-primary)]">~$35.7M</strong>. Robinhood Chain's launch is the macro event — the first major broker-to-L2 play.{' '}
      ...
      <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] rounded-2xl p-5 my-4">
        ...
        <p className="text-xs text-[var(--text-muted)] mt-3">Sources: SEC, EFF, Congressional tracker</p>
      </div>
